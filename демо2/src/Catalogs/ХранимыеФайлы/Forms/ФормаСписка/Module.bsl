...
#Если НЕ МобильныйКлиент Тогда
	...
	Элементы.ФормаПоделитьсяФайл.Видимость = Ложь;
#Иначе
	...
	КонецЕсли;
	Элементы.ФормаПоделитьсяФайл.Видимость = СредстваПередачиДанныхНаУстройстве.ПоддерживаетсяВозможностьПоделитьсяДанными();
#КонецЕсли
КонецПроцедуры
...
&НаКлиенте
Функция ПолучитьХранимыйФайл(ХранимыйФайл)
...
&НаКлиенте
Процедура ПоделитьсяФайл(Команда)
#Если МобильныйКлиент Тогда
	ХранимыйФайл = Элементы.Список.ТекущиеДанные;
	Если ХранимыйФайл <> Неопределено Тогда
		ИмяФайла = ПолучитьХранимыйФайл(ХранимыйФайл);
		Данные = Новый ДанныеМультимедиа(ИмяФайла);
		СредстваПередачиДанныхНаУстройстве.ПоделитьсяДанными(Данные);
	КонецЕсли;	
#КонецЕсли
КонецПроцедуры
